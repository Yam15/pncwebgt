...
@Component({
    ...
    AppFloatingConfigurator, ReactiveFormsModule, MatFormFieldModule, MatInputModule, MatButtonModule, StyleClassModule],
    template: `
        ...
        <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden">
            <div class="flex flex-col items-center justify-center">
                <div style="border-radius: 56px; padding: 0.5rem; background: linear-gradient(180deg, var(--primary-color) 100%, rgba(0, 0, 0, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            ...
                            <img src="https://i0.wp.com/pnc.gob.gt/wp-content/uploads/2023/08/Logo-PNC.png?ssl=1" width="100px" alt="LOGO" class="layout-login-logo"/> 
                           
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">PNCWEB</div>
                            <span class="text-muted-color font-medium">Sign in to continue</span>
                        </div>

                        <div>
                            <!-- <label for="email1" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Email</label>
                            <input pInputText id="email1" type="text" placeholder="Email address" class="w-full md:w-[30rem] mb-8" (ngSubmit)="onSubmit()" />
            ...
            <div class="containter">
                ...
                <button label="Sign In"  style="width: 250px; height: 50px; background-color: blue;" styleClass="w=full" mat-flat-button type="submit">Login</button>
                </div>
            </div>
            </form>
                 ...
                 <p-button classstyle="width: 250px; height: 50px; background-color: blue;" styleClass="w=full" routerLink="/">Regresar</p-button>         
